...
public static class DressUpModel
{
    public static string GetMetatableName() => "DressUpModelMetaTable";

    public static Widgets.DressUpModel? GetThis(lua_State L, int index)
    {
        ...
        return handle.Target as Widgets.DressUpModel;
    }
