...
{
    private static string GetMetatableName() => "MinimapMetaTable";

    private static Widgets.Minimap? GetThis(lua_State L, int index)
    {
        ...
        return handle.Target as Widgets.Minimap;
    }
