...
{
    public static string GetMetatableName() => "TextureMetaTable";

    public static Widgets.Texture? GetThis(lua_State L, int index)
    {
        ...
        return handle.Target as Widgets.Texture;
    }
